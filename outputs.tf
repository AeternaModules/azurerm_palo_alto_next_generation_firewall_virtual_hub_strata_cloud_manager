output "palo_alto_next_generation_firewall_virtual_hub_strata_cloud_managers_id" {
  ...
  value       = { for k, v in azurerm_palo_alto_next_generation_firewall_virtual_hub_strata_cloud_manager.palo_alto_next_generation_firewall_virtual_hub_strata_cloud_managers : k => v.id }
}
